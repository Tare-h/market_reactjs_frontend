    ...
    let acategory = this.props.categories.map((campaignCategoryObj) => (
      ...
      >
        <NavLink
          ...
          to={`/categories/${campaignCategoryObj.category_name_en}/${campaignCategoryObj.id}`}
          id={`/categories/${campaignCategoryObj.show_pages}`}
          data-hover="dropdown"
        ...
        >
          ...
          {getLang() == "en" ? (
            <font style={{ verticalAlign: "inherit" }}>
              <br />
              <font style={{ verticalAlign: "inherit" }}>Mall</font>
            </font>
          ) : (
            <span></span>
          )}
